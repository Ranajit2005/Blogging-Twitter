...
//   console.log("From post card profile 1 :",posts)
//   console.log("From post card profile 2 :",post)
//   console.log("From post card profile 3:",user)
//   console.log("From post card profile 4:")
    ...
    <div className="p-3 lg:p-7">
          ...
          <div>
            ...
            <div className="flex items-center mt-3 gap-10">
              ...
              {post?.user == currentUser?.data?.currentUser?.[0]?._id && (
                <div
                  className={`flex flex-row items-center text-neutral-500 gap-2 cursor-pointer transition hover:text-red-500`}
